...
-X 'github.com/DanielKirkwood/youchoose/main.ModuleName=github.com/DanielKirkwood/youchoose'\
-X 'github.com/DanielKirkwood/youchoose/main.Commit=$(ARG_COMMIT)'\
-X 'github.com/DanielKirkwood/youchoose/main.BuildDate=$(ARG_BUILD_DATE)'\
")$(LDFLAGS)
